...
export async function sendInviteEmail(
  ...
  const htmlBody = `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px 24px;">
      <h2 style="color: #1e293b; margin-bottom: 8px;">You're invited to Social Post Pro</h2>
      <p style="color: #64748b; font-size: 15px; line-height: 1.6;">
        ${inviterName} has invited you to join Social Post Pro — an AI-powered content generation platform.
      </p>
    ...
    const res = await fetch(
      "https://services.leadconnectorhq.com/conversations/messages/email",
      {
        ...
        body: JSON.stringify({
          ...
          contactId: toEmail,
          emailTo: toEmail,
          subject: `${inviterName} invited you to Social Post Pro`,
          html: htmlBody,
        }),
      }
    );
