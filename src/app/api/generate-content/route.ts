...
- Reels (talking-head video scripts): ${counts.reels}. Each needs: script (a direct-to-camera script for someone to speak, approximately 30 seconds when read aloud - NO scene directions, NO B-roll instructions, just the actual words to say, must address an aspect of the theme), optional imagePrompt for thumbnail.
