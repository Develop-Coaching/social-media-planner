  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-slate-900">
      <header className="bg-brand-primary">
        <div className={`px-4 sm:px-6 py-4 sm:py-6 ${headerTextLight ? "text-slate-900" : "text-white"}`}>
      ...
      <div className="px-4 sm:px-6 py-6 pb-24 lg:flex lg:gap-8 lg:items-start">
