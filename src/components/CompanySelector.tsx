        ...
        {loading ? (
          <div className="grid gap-4 sm:grid-cols-2">
            {[0, 1, 2, 3].map((i) => (
              <div
                key={i}
                className="rounded-2xl bg-white dark:bg-slate-800 p-8 shadow-sm border border-slate-100 dark:border-slate-700 animate-pulse"
              >
                <div className="w-14 h-14 rounded-xl bg-slate-200 dark:bg-slate-700 mb-4" />
                <div className="h-5 w-2/3 rounded bg-slate-200 dark:bg-slate-700 mb-2" />
