...
export default function LogoutButton({ variant = "header", suppressTitle = false }: { variant?: "header" | "page"; suppressTitle?: boolean }) {
  ...
  return (
    <>
      <button
        ...
        title={suppressTitle ? undefined : "Sign out"}
      >
