...
export type GeneratedContent = {
  ...
  reels: { title: string; script: string; caption: string; rawVideoFileId?: string; rawVideoUrl?: string; rawVideoName?: string; finishedVideoFileId?: string; finishedVideoUrl?: string; finishedVideoName?: string }[];
